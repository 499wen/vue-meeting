    ...
    <div class="atte-data">
      ...
      <div class="data-oper">
        <div class="data-add" v-show='!curAttenGroup.parentId'>
          <el-button v-preventReClick round size='small' type="primary" @click="addAtteBtn">添加参会人</el-button>
          <el-button v-preventReClick round size='small' type="danger">移除参会人</el-button>
          <el-button v-preventReClick round size='small' type="primary" v-if="false">手动录入</el-button>
        </div>
        <div class="data-query" v-if="false">
          <el-button v-preventReClick class="spacing" size='small' @click="exportAtten">导出参会人</el-button>
          <!-- 条件组查询 -->
